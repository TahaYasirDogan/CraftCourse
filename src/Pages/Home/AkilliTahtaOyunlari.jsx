...
import './AkilliTahtaOyunlari.css';

const AkilliTahtaOyunlari = () => {
  // Oyun kutularını dinamik olarak oluşturmak için örnek bir oyun listesi
  const oyunlar = [
...
export default AkilliTahtaOyunlari;